            ...
            <div class="p-4 sm:p-7">
                ...
                <div class="text-center">
                    <h1 class="block text-2xl font-bold text-gray-800 dark:text-white">
                        <?php echo e(__('auth.register_title')); ?>

                    </h1>
                    <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">
                        <?php echo e(__('auth.register_haveaccount')); ?>  &nbsp;
                        <a href="<?php echo e(route('login')); ?>" class="text-blue-600 decoration-2 hover:underline font-medium dark:text-white">
                            <?php echo e(__('auth.register_signin')); ?>
                        ...
                        <div class="grid gap-y-4">
                            <div>
                                <label for="email" class="block text-sm mb-2 dark:text-white">
                                    <?php echo e(__('auth.register_email')); ?>
                            ...
                            <div>
                                <div class="flex justify-between items-center">
                                    <label for="password" class="block text-sm mb-2 dark:text-white">
                                        <?php echo e(__('auth.register_password')); ?>
                            ...
                            <div>
                                <div class="flex justify-between items-center">
                                    <label for="confirm-password" class="block text-sm mb-2 dark:text-white">
                                        <?php echo e(__('auth.register_confirmpassword')); ?>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="flex items-center">
                                ...
                                <div class="ml-3">
                                  ...
                                  >
                                    <a
                                    class="text-blue-600 decoration-2 hover:underline font-medium dark:text-white"
                                      href="#"
                                    >
                                    <?php echo e(__('auth.register_accept')); ?>
                            ...
                            <button type="submit"
                                ...
                                <?php echo e(__('auth.register_submit')); ?>
...
<?php echo $__env->make('layouts.ghost', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OSPanel\domains\jiu-api.loc\resources\views/auth/register.blade.php ENDPATH**/ ?>