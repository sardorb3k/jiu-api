        ...
        <div id="hs-vertically-centered-modal"
            ...
            <div
                ...
                <div
                    ...
                    <form method="POST" action="<?php echo e(route('departments.create')); ?>">
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-1 gap-4 lg:gap-6">
                                    ...
                                    <div>
                                        <label for="description"
                                            class="block text-sm text-gray-700 font-medium dark:text-white">
                                            Description <span class="text-red-800">*</span>
                                        </label>
                                ...
                                <tbody class="divide-y divide-gray-200 dark:divide-gray-700">
                                    ...
                                    <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td class="h-px w-auto whitespace-nowrap">
                                                <div class="px-6 py-2">
                                                    <form action="<?php echo e(route('departments.delete')); ?>"
                                                        method="POST">
                                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OSPanel\domains\jiu-api.loc\resources\views/department/index.blade.php ENDPATH**/ ?>