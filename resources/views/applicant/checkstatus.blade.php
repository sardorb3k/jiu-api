@extends('layouts.app')
@section('title', __('deportment.checkstatus_title'))
@section('content')
    <x-ApplicantNav action='examday' />
    ...
    <div class="max-w-3xl mx-auto">
        <div class="max-w-xl mx-auto">
            <div class="">
                @if ($enrollmentstatus)
                    <div class="{{ $enrollmentstatus->status == '2' ? 'bg-red-700' : 'bg-blue-800' }} text-sm bg-blue-800 text-white rounded-md p-4 mt-5"
                        role="alert">
        ...
        @permission('personal-student')
            <div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
                <div class="max-w-xl mx-auto">
                    ...
                    <div class="mt-12">
                        <form method="POST" action="{{ route('applicant.infoupdate') }}">
                            @csrf
                            ...
                            <div class="mt-6 grid">
                                <input type="hidden" name="enrollment_id" value="{{ $enrollmentstatus->id  }}">
                                <button type="submit"
